...
nhmc.ctrl.addCity = function(cityName, cityData) {
    ...
    var cityLabel = nhmc.surface.createText({
        ...
        y: cityMarkerData.cy + (cityMarkerData.fontSize / 2) - 3,
    ...
    if (cityLabel.getShape().align != 'end') {
        var cityBGData = {
            ...
            arcsSweep: 0,
            labelN: [cityLabel.getShape().x + cityLabel.getTextWidth() + 2, cityLabel.getShape().y - cityMarkerData.fontSize - cityMarkerData.r + 2],
            labelS: [cityLabel.getShape().x + cityLabel.getTextWidth() + 2, cityLabel.getShape().y + cityMarkerData.r + 2],
            markerN: [cityMarkerData.cx, cityLabel.getShape().y - cityMarkerData.fontSize - cityMarkerData.r + 2],
            markerS: [cityMarkerData.cx, cityLabel.getShape().y + cityMarkerData.r + 2]
        };
    } else {
        var cityBGData = {
            r: (cityMarkerData.fontSize + (2 * cityMarkerData.r)) / 2,

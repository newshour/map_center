            ...
            function loadMoreOfState() {
                if (step < totalSteps) {
                    ...
                    for (var j=startBreak; j<endBreak; j++) {
                        ...
                        nhmc.geo.usGeo[state].countyPaths[keys[j]].attr(defaultAttributes).translate(0, -300);
            ...
            function loadMoreCounties() {
                if (step < totalSteps) {
                    ...
                    for (var i=startBreak; i<endBreak; i++) {
                        ...
                        nhmc.geo.countyGeo[keys[i]].attr(defaultAttributes);
...
nhmc.mapCenterInit = function() {
    ...
    for (var i in nhmc.geo.usGeo) {
        ...
        nhmc.geo.usGeo[i].statePath.attr(defaultAttributes);

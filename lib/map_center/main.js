...
nhmc.mapCenterInit = function() {
    ...
    $('#scale_one_quarter').click(function() {
        nhmc.ctrl.scaleCurrentMap(0.25);
        return false;
    });
    $('#scale_half').click(function() {
        nhmc.ctrl.scaleCurrentMap(0.5);
        return false;
    });
    $('#scale_three_quarters').click(function() {
        nhmc.ctrl.scaleCurrentMap(0.75);
        return false;
    });
    $('#scale_full').click(function() {
        nhmc.ctrl.scaleCurrentMap(1.0);
        return false;
    });
};
$(document).ready(function() {
    ...
    dojo.addOnLoad(function() {
        var initHeight = nhmc.config.defaultDimensions.height;
        var initWidth = nhmc.config.defaultDimensions.width;
        nhmc.surface = dojox.gfx.createSurface('map', initWidth, initHeight);

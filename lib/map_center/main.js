...
nhmc.ctrl.zoomToState = function(state) {
    ...
    if (state != 'us_all' && state != 'us_counties') {
        ...
        // FIXME: What is different about this case? Statewide county maps and
        //  the nationwide county map both work, but not this one.
        //  nhmc.mapSpecificInit() isn't getting called at all in this case.
...
$(document).bind('drawingComplete', function(e, location) {
    console.log('drawingComplete fired at ' + location);
    console.log(e);
});

            ...
            function loadMoreOfState() {
                if (step < totalSteps) {
                    ...
                    for (var cityName in nhmc.geo.usGeo[state].cities) {
                        ...
                        var cityBackgroundRadius = 2 * cityMarkerData.r;
                        ...
                        var cityBackground = nhmc.surface.createPath()
                            .moveTo(cityMarkerData.cx, cityMarkerData.cy + (2 * cityMarkerData.r))
                            .lineTo(cityLabel.getShape().x + cityLabel.getTextWidth(), cityMarkerData.cy + (2 * cityMarkerData.r))
                            .arcTo(cityBackgroundRadius, cityBackgroundRadius, 270, 0, 0, cityLabel.getShape().x + cityLabel.getTextWidth(), cityMarkerData.cy - (2 * cityMarkerData.r))
                            .lineTo(cityMarkerData.cx, cityMarkerData.cy - (2 * cityMarkerData.r))
                            .arcTo(cityBackgroundRadius, cityBackgroundRadius, 90, 0, 0, cityMarkerData.cx, cityMarkerData.cy + (2 * cityMarkerData.r))
                            .closePath()
                            .setFill({
                                r: 255,
                                g: 255,
                        ...
                        nhmc.geo.usGeo[state].cityPaths[j] = cityGroup;
                    }

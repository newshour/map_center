            ...
            function loadMoreOfState() {
                if (step < totalSteps) {
                    ...
                    for (var cityName in nhmc.geo.usGeo[state].cities) {
                        ...
                        // Draw the circle centered on the city's coordinates.
                        var cityMarkerData = {
                            cx: cityData[0][0],
                            cy: cityData[0][1],
                            r: nhmc.config.cityRadii[cityData[1]] || nhmc.config.cityRadii[0]
                        };
                        ...
                        var cityBGData = {
                            ...
                            ne: [cityLabel.getShape().x + cityLabel.getTextWidth(), cityMarkerData.cy - (2 * cityMarkerData.r)],
                            nw: [cityMarkerData.cx, cityMarkerData.cy - (2 * cityMarkerData.r)],
                            se: [cityLabel.getShape().x + cityLabel.getTextWidth(), cityMarkerData.cy + (2 * cityMarkerData.r)],
                            sw: [cityMarkerData.cx, cityMarkerData.cy + (2 * cityMarkerData.r)]
                        };
                        var cityBackground = nhmc.surface.createPath()
                            .moveTo(cityBGData.sw[0], cityBGData.sw[1])
                            .lineTo(cityBGData.se[0], cityBGData.se[1])
                            .arcTo(cityBGData.r, cityBGData.r, 270, 0, 0, cityBGData.ne[0], cityBGData.ne[1])
                            .lineTo(cityBGData.nw[0], cityBGData.nw[1])
                            .arcTo(cityBGData.r, cityBGData.r, 90, 0, 0, cityBGData.sw[0], cityBGData.sw[1])
                            .closePath()
                            .setFill({
                                r: 255,
                                g: 255,

...
nhmc.ctrl.addCity = function(cityName, cityData) {
    ...
    if (cityLabel.getShape().align != 'end') {
        var cityBGData = {
            ...
            arcsSweep: 0,
            labelN: [cityLabel.getShape().x + cityLabel.getTextWidth() - (2 * cityMarkerData.r), cityMarkerData.cy - (2 * cityMarkerData.r)],
            labelS: [cityLabel.getShape().x + cityLabel.getTextWidth() - (2 * cityMarkerData.r), cityMarkerData.cy + (2 * cityMarkerData.r)],

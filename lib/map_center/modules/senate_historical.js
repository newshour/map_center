$(document).ready(function() {
    ...
    $('#senate_current a').click(function() {
        ...
        nhmc.ctrl.renderLegend('Current Senate by party', [
            ['Two Republicans', 'red'],
            ['Two Democrats', 'blue'],
            ['One Republican, one Democrat', 'purple'],
            ['One Democrat, one independent', 'orange']
        ]);
        nhmc.ctrl.setStateColors(senators.rr, 'red');
        nhmc.ctrl.setStateColors(senators.dd, 'blue');
        nhmc.ctrl.setStateColors(senators.rd, 'purple');
        nhmc.ctrl.setStateColors(senators.di, 'orange');

                ...
                for (var i in nhmc.geo.usGeo) {
                    ...
                    switch (stateClass) {
                        case 'Nebraska':
                            ...
                            var eventToken = dojo.connect(nhmc.geo.usGeo['Nebraska'].statePath.getNode(), 'onclick', nebraskaHandler);
                        ...
                        case 'Maine':
                            ...
                            var eventToken = dojo.connect(nhmc.geo.usGeo['Maine'].statePath.getNode(), 'onclick', maineHandler);
                            nhmc.cleanup.clickHandlerTokens.push(eventToken);
                            break;
                        ...
                        default:
                            function genericHandler() {
                                ...
                                if (nhmc.geo.usGeo[stateUnescaped].statePath.getFill().toString() == dojox.gfx.normalizeColor(nhmc.config.styleColors['red']).toString()) {
                                    nhmc.charts.lowerChart.series[2].setData([{
                                        color: nhmc.config.styleColors['red'],
                                        y: oldRed - votes
                                    }]);
                                ...
                                } else if (nhmc.geo.usGeo[stateUnescaped].statePath.getFill().toString() == dojox.gfx.normalizeColor(nhmc.config.styleColors['blue']).toString()) {
                                    nhmc.charts.lowerChart.series[0].setData([{
                                        color: nhmc.config.styleColors['blue'],
                                        y: oldBlue - votes
                                    }]);
                                ...
                                } else if (nhmc.geo.usGeo[stateUnescaped].statePath.getFill().toString() == dojox.gfx.normalizeColor(nhmc.config.styleColors['yellow']).toString()) {
                                    nhmc.charts.lowerChart.series[1].setData([{
                                        color: nhmc.config.styleColors['yellow'],
                                        y: oldYellow - votes
                                    }]);
                            ...
                            var eventToken = dojo.connect(nhmc.geo.usGeo[i].statePath.getNode(), 'onclick', genericHandler);
                            nhmc.cleanup.clickHandlerTokens.push(eventToken);
                            break;
                    }
                }

                ...
                for (var i in nhmc.geo.usGeo) {
                    ...
                    switch (stateClass) {
                        case 'Nebraska':
                            ...
                            $(nhmc.geo.usGeo['Nebraska'].statePath.getNode()).click(nebraskaHandler);
                            break;
                        ...
                        case 'Maine':
                            ...
                            $(nhmc.geo.usGeo['Maine'].statePath.getNode()).click(maineHandler);
                            break;
                        ...
                        default:
                            ...
                            $(nhmc.geo.usGeo[i].statePath.getNode()).click(genericHandler);
                            break;
                    }
                }

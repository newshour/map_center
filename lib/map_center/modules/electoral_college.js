            ...
            $('#electoral_college_change a').click(function() {
                ...
                switch (nhmc.geo.usGeo['Nebraska'].statePath.attr('fill')) {
                    ...
                    case styleColors['blue']:
                        ...
                        $('#nebraska_5').val('d');
                        break;
                    case styleColors['yellow']:
                        $('#nebraska_popular').val('t');
                        $('#nebraska_4').val('t');
                        $('#nebraska_5').val('t');
                        break;
                    case styleColors['default']:  // fall through
                    default:
                ...
                for (var i in nhmc.geo.usGeo) {
                    ...
                    switch (stateClass) {
                        case 'Nebraska':
                            ...
                            if (nhmc.geo.usGeo['Nebraska'].statePath.attr('fill') == styleColors['red']) {
                                nebraskaVotes.republican = electoralVotes['2012'].states['Nebraska'];
                            } else if (nhmc.geo.usGeo['Nebraska'].statePath.attr('fill') == styleColors['blue']) {
                                nebraskaVotes.democratic = electoralVotes['2012'].states['Nebraska'];
                            } else if (nhmc.geo.usGeo['Nebraska'].statePath.attr('fill') == styleColors['yellow']) {
                                ...
                                function updateNebraska() {
                                    ...
                                    switch ($('#nebraska_popular').val() + $('#nebraska_4').val() + $('#nebraska_5').val()) {
                                        ...
                                        case 'tdr':
                                            ...
                                            break;
                                        default:
                                            setStateColors(['Nebraska'], 'default');
                                            break;
                                    }
                                }
                        ...
                        case 'Maine':
                            ...
                            if (nhmc.geo.usGeo['Maine'].statePath.attr('fill') == styleColors['red']) {
                                maineVotes.republican = electoralVotes['2012'].states['Maine'];
                            } else if (nhmc.geo.usGeo['Maine'].statePath.attr('fill') == styleColors['blue']) {
                                maineVotes.democratic = electoralVotes['2012'].states['Maine'];
                            } else if (nhmc.geo.usGeo['Maine'].statePath.attr('fill') == styleColors['yellow']) {

...
$(document).one('coreInitialized', function() {
    ...
    if (calculatorActive) {
        ...
        // Check whether we're starting with AP projections; if so, add that
        // attribution--but remove it once people actually change things.
        ...
        if (currentView) {
            ...
            if (currentView == apCompressed) {
                ...
                mapStatus.eventBus.one("change", function(event, status) {

...
$(document).one('coreInitialized', function() {
    ...
    function liveDataInit(data) {
        ...
        for (var i = 0, length = data.breakdown.length; i < length; i++) {
            ...
            // FIXME: This is a hack from hell to get the winner to show up
            //  properly since Maine does weird things. Make it cleaner
            //  for the future.
            ...
            if (data.winners[nhmc.config.USPSToState[stateShowing]] == candidateId) {

...
nhmc.mapSpecificInit = function() {
    ...
    function liveDataInit(data) {
        ...
        if ($('#precincts').length == 0) {
            $('#live_legend').before('<p id="precincts"></p>');
        }
        $('#precincts').html('<span id="precincts_reporting">' + data.precincts[0] + '</span> of <span id="precincts_total">' + data.precincts[1] + '</span> precincts reporting');
    ...
    function sidebarInit() {
        ...
        $('#live_legend').after('<p id="live_legend_control"><a href="#" id="live_legend_show_all" class="control_all">Show all</a><a href="#" id="live_legend_clear_all" class="control_all">Clear all</a></p>');
        nhmc.cleanup.futureGarbage.push($('#live_legend_control'));
    }

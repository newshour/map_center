...
$(document).one('coreInitialized', function() {
    ...
    if (typeof(nhmc_static_flyouts) != 'undefined') {
    ...
    if (flyoutConfig) {
        nhmc.tooltips.render = function() {
            ...
            $('body').append('<div id="tooltip" class="tooltip_flyout">' + tooltipFormatter(thisFIPS, thisState, thisCounty, countyOnly, currentData) + '</div>');
        ...
        nhmc.tooltips.render = function() {
            ...
            $('body').append('<div id="tooltip">' + tooltipFormatter(thisFIPS, thisState, thisCounty, countyOnly, currentData) + '</div>');
            if (Modernizr.touch) {nhmc.tooltips.addClose();}
        };
        if (nhmc.tooltips.hoverHandlerTokens.length == 0) {
            nhmc.tooltips.init();

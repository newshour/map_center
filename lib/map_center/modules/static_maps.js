...
$(document).one('coreInitialized', function() {
    ...
    function staticTypesInit(data) {
        ...
        if (typeof(data.seriesName) != 'undefined') {
            $('.static_map_name').html(data.seriesName);
        }
        if (typeof(data.sidebarTitle) != 'undefined') {
            $('#sidebar_title').html(data.sidebarTitle);
        }
        ...
        if (data.categories) {
            ...
            var breakFormatter = typeof(nhmcStaticBreakFormatter) != 'undefined' ?nhmcStaticBreakFormatter : function(thisBreak, prevBreak, isLastBreak, breakPrefix, breakSuffix, breakDecimals) {
                if (isLastBreak) {
                    return '&gt;' + breakPrefix + prevBreak.toFixed(breakDecimals) + breakSuffix;
                    ...
                    return '&le;' + breakPrefix + thisBreak.toFixed(breakDecimals) + breakSuffix;
                }
            };
    ...
    $('.view_tab_more .view_tab_option').not('#view_tab_more_shown')
    .click(function() {
    ...
    $('.view_tab_options_more .view_tab_option')

    ...
    function staticTypesInit() {
        ...
        if (nhmcStatic.categories) {
            ...
            for (var i = 0, length = nhmcStatic.breaks.length; i < length; i++) {
                ...
                if (i == 0) {
                    breakText = '&lt;' + breakPrefix + nhmcStatic.breaks[i].toFixed(0) + breakSuffix;
                } else if (i == length - 1) {
                    breakText = '&ge;' + breakPrefix + nhmcStatic.breaks[i - 1].toFixed(0) + breakSuffix;
                } else {
                    breakText = breakPrefix + nhmcStatic.breaks[i].toFixed(0) + breakSuffix + '&ndash;' + breakPrefix + nhmcStatic.breaks[i + 1].toFixed(0) + breakSuffix;
                }
